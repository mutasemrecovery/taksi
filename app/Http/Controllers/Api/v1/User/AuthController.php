    ...
    public function register(Request $request)
    {
        ...
        if ($userType == 'driver') {
            $validator = Validator::make($request->all(), [
                ...
                'photo_of_car' => 'nullable|image|mimes:jpeg,png,jpg|max:6048',
                ...
                // Documents
                'driving_license_front' => 'nullable|image|mimes:jpeg,png,jpg|max:6048',
                'driving_license_back' => 'nullable|image|mimes:jpeg,png,jpg|max:6048',
                'car_license_front' => 'nullable|image|mimes:jpeg,png,jpg|max:6048',
                'car_license_back' => 'nullable|image|mimes:jpeg,png,jpg|max:6048',
            ]);
        } else {
            $validator = Validator::make($request->all(), [
                'name' => 'required|string|max:255',
    ...
    public function updateDriverProfile(Request $request)
    {
        try {
            ...
            $validationRules = [
                ...
                'photo_of_car' => 'nullable|image|max:6048',
                'model' => 'nullable|string|max:255',
                'production_year' => 'nullable|string|max:4',
                'color' => 'nullable|string|max:255',
                'plate_number' => 'nullable|string|max:255',
                'driving_license_front' => 'nullable|image|max:6048',
                'driving_license_back' => 'nullable|image|max:6048',
                'car_license_front' => 'nullable|image|max:6048',
                'car_license_back' => 'nullable|image|max:6048',
