                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="coupon_type" name="coupon_type" required>
                                <option value="1" {{ old('coupon_type', 1) == 1 ? 'selected' : '' }}>{{ __('messages.All_Rides') }}</option>
                                <option value="2" {{ old('coupon_type') == 2 ? 'selected' : '' }}>{{ __('messages.First_Ride') }}</option>
                                <option value="3" {{ old('coupon_type') == 3 ? 'selected' : '' }}>{{ __('messages.Specific_Service') }}</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="discount_type" name="discount_type" required>
                                <option value="1" {{ old('discount_type', 1) == 1 ? 'selected' : '' }}>{{ __('messages.Fixed_Amount') }}</option>
                                <option value="2" {{ old('discount_type') == 2 ? 'selected' : '' }}>{{ __('messages.Percentage') }}</option>
                            </select>
                        </div>
