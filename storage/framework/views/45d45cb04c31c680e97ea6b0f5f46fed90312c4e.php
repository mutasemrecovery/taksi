                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="referral_code" name="referral_code" value="<?php echo e(old('referral_code')); ?>">
                            <small class="form-text text-muted"><?php echo e(__('messages.Referral_Code_Info')); ?></small>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\uber\resources\views/admin/users/create.blade.php ENDPATH**/ ?>